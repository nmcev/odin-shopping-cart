...
function Cart() {
    ...
    return (
    <div className="pt-24 bg-silver flex justify-center pb-12 dark:bg-dark">
        <div className=' max-w-6xl w-full  max-sm:h-auto max-sm:pb-4 flex flex-col gap-y-8  '>
            <div className='flex flex-col w-full pt-12 items-center '>
                <h2 className='uppercase font-montserrat-reg text-20 dark:text-creamy'>Cart</h2>
            </div>
            
            <div className='border-b-2 border-border flex justify-between text-dimGray font-montserrat-reg px-6 pb-2 max-sm:hidden dark:text-creamy'>
                    <h5>Product</h5>
                ...
                <div className="px-4 max-sm:text-16 border-t-2 border-border">
                    <div className='flex justify-between items-center pt-12 dark:text-creamy'>
                    ...
                    <div className='flex justify-center items-center h-96 divide-y-0 dark:text-creamy'>
