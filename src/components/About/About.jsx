                   ...
                   <section>
                    ...
                    <section>
                        <p className='text-dark font-Nunito leading-7 dark:text-creamy'>
                            ...
                            and <a className=' underline-offset-2 underline' href='https://unsplash.com/@pratiksha_mohanty'>Pratiksha Mohanty</a> for the image in the <code className=' bg-zinc-200  dark:bg-slate-500 text-sm py-1'>allProducts</code> page.
                        </p>
                    </section>
