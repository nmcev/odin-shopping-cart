  ...
  const description = 'Explore our curated collection – diverse, versatile items for every need. From essentials to unique finds, discover quality products suitable for gifting.'
    ...
    <SidePageAndItems>
        <div className="w-10/12 flex justify-center pb-8 relative">
         <img src={img} alt="Candle and planets" className="w-full max-w-4xl max-h-80 object-cover object-center rounded-lg shadow-lg z-10" loading="lazy" />
          ...
          <div className=" text- w-10/12 flex flex-col items-center  max-sm:items-start max-sm:pt-6 max-sm:pl-6 pb-24">
            <h3 className="text-2xl  font-bold font-poppins text-dimGray max-sm:text-lg ">Our Products</h3>
            <p className="text-dark max-sm:text-start text-center max-sm:text-sm max-w-2xl pt-2">Explore our curated collection – diverse, versatile items for every need. From essentials to unique finds, discover quality products suitable for gifting.</p>
          </div>
